      ...
      case 'remove':
        if (chat.welcome) {
          ...
          for (let user of participants) {
            ...
            let pp = 'https://i.ibb.co/x2P9fYh/Free-Sample-By-Wix-1.jpg'
            let ppgc = 'https://i.ibb.co/x2P9fYh/Free-Sample-By-Wix-1.jpg'
            try {
...
`.trim(), m.message, {
  ...
  async onCall(json) {
    ...
    user.call += 1
    await this.reply(from, `Jika kamu menelepon bot, kamu akan diblokir.\n\n${user.call} / 1`, null)
    if (user.call == 1) {
